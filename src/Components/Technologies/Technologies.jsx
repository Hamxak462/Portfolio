        ...
        <div className="col-md-10 col-sm-12">
          ...
          >
            ...
            <div className="col-md-2  list_img1 all_imgs py-2 d-flex justify-content-center">
              <img
                src="svg folder/bootstrap2-removebg-preview.png"
                alt="list_img1"
                style={{
                  width: "70%",
                  height: "70%",
            ...
            <div className="col-md-2 list_img1 all_imgs py-2 d-flex justify-content-center">
              <img
                src="svg folder/react-3-removebg-preview.png"
                alt="list_img1"
            ...
            <div className="col-md-2 list_img1 all_imgs py-2 d-flex justify-content-center">
              <img
                src="svg folder/nodejs-removebg-preview.png"
                alt="list_img1"
                style={{ width: "75px", height: "75px", margin: "2px 13px" }}
              />
            </div>
            <div className="col-md-2 list_img1 all_imgs py-2 d-flex justify-content-center">
              <img
                src="svg folder/gsap-removebg-preview.png"
                alt="list_img1"
                style={{
                  width: "75px",
                }}
